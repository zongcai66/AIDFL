...
logging.basicConfig(filename='fmnist_Krum_7_label.txt', level=logging.INFO, format='%(asctime)s - %(message)s')
...
client_subset_01= ChangeableSubset(
    fmnist_full,clients_index[0], label_flipping=True, data_poisoning=False, poisoned_persent=1, targeted=False)
client_subset_02= ChangeableSubset(
    fmnist_full,clients_index[2], label_flipping=True, data_poisoning=False, poisoned_persent=1, targeted=False)
client_subset_03= ChangeableSubset(
    fmnist_full,clients_index[3], label_flipping=True, data_poisoning=False, poisoned_persent=1, targeted=False)
client_subset_04= ChangeableSubset(
    fmnist_full,clients_index[4], label_flipping=True, data_poisoning=False, poisoned_persent=1, targeted=False)
client_subset_05= ChangeableSubset(
    fmnist_full,clients_index[6], label_flipping=True, data_poisoning=False, poisoned_persent=1, targeted=False)
client_subset_06= ChangeableSubset(
    fmnist_full,clients_index[8], label_flipping=True, data_poisoning=False, poisoned_persent=1, targeted=False)
client_subset_07= ChangeableSubset(
    fmnist_full,clients_index[9], label_flipping=True, data_poisoning=False, poisoned_persent=1, targeted=False)
