...
logging.basicConfig(filename='mnist_AIDFL_7_data_iid.txt', level=logging.INFO, format='%(asctime)s - %(message)s')
...
#
# index_1 = range(60000)
# mnist_full.data = mnist_full.data[index_1]
# mnist_full.targets = mnist_full.targets[index_1]
...
client_subset_01= ChangeableSubset(
    mnist_full,clients_index[0], label_flipping=False, data_poisoning=True, poisoned_persent=1,
    poisoned_ratio=1, targeted=False, noise_type='salt')
client_subset_02= ChangeableSubset(
    mnist_full,clients_index[2], label_flipping=False, data_poisoning=True, poisoned_persent=1,
    poisoned_ratio=1, targeted=False, noise_type='salt')
client_subset_03= ChangeableSubset(
    mnist_full,clients_index[3], label_flipping=False, data_poisoning=True, poisoned_persent=1,
    poisoned_ratio=1, targeted=False, noise_type='salt')
client_subset_04= ChangeableSubset(
    mnist_full,clients_index[4], label_flipping=False, data_poisoning=True, poisoned_persent=1,
    poisoned_ratio=1, targeted=False, noise_type='salt')
client_subset_05= ChangeableSubset(
    mnist_full,clients_index[6], label_flipping=False, data_poisoning=True, poisoned_persent=1,
    poisoned_ratio=1, targeted=False, noise_type='salt')
client_subset_06= ChangeableSubset(
    mnist_full,clients_index[8], label_flipping=False, data_poisoning=True, poisoned_persent=1,
    poisoned_ratio=1, targeted=False, noise_type='salt')
client_subset_07= ChangeableSubset(
    mnist_full,clients_index[9], label_flipping=False, data_poisoning=True, poisoned_persent=1,
    poisoned_ratio=1, targeted=False, noise_type='salt')
